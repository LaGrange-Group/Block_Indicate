            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Symbol = table.Column<string>(nullable: true),
                    High = table.Column<decimal>(type: "decimal(18, 18)", nullable: false),
                    Low = table.Column<decimal>(type: "decimal(18, 18)", nullable: false),
                    Open = table.Column<decimal>(type: "decimal(18, 18)", nullable: false),
                    Close = table.Column<decimal>(type: "decimal(18, 18)", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18, 18)", nullable: false),
                    DayAmount = table.Column<decimal>(type: "decimal(18, 18)", nullable: false),
                    KlineVolume = table.Column<decimal>(type: "decimal(18, 18)", nullable: false),
                    DayVolume = table.Column<decimal>(type: "decimal(18, 18)", nullable: false),
                    TradeCount = table.Column<int>(nullable: false),
                    DayTradeCount = table.Column<int>(nullable: false),
                    TimeStamp = table.Column<DateTime>(nullable: false),
                    RealTime = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HuobiData", x => x.Id);
                });
